...
public class LoginActivity extends AppCompatActivity {
    ...
    Button signInButton;
    EditText phoneNumberEditTxt, addressEditTxt, cityNameEditTxt, PinCodeExitText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PinCodeExitText = (EditText) findViewById(R.id.PinCodeExitText);
        addressEditTxt = (EditText) findViewById(R.id.AddressEditText);
        signInButton = (Button) findViewById(R.id.GoogleSignInBtn);


        //Google Signin Options to get gmail and performs gmail login
        ...
        signInButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String pinCode = PinCodeExitText.getText().toString();
